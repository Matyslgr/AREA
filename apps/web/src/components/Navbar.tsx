      ...
      <div className="fixed top-0 left-0 right-0 z-50 p-6 md:p-10">
          <nav className="mx-auto max-w-4xl rounded-full bg-white px-6 py-3 shadow-sm">
              <div className="flex items-center justify-between">
                  <a className="text-lg font-medium text-gray-800 ml-4 cursor-pointer" onClick={() => navigate("/")}>
                    AREA
                  </a>
                  ...
                  <div className="hidden md:flex items-center gap-3">
                    {isAuthenticated ? (
                      <>
                        ...
                        <Button
                          className="rounded-full bg-[#D4E3FE] p-2 text-gray-800 hover:bg-[#c4d3ee]"
          ...
          <div className="flex flex-col gap-4">
            {isAuthenticated ? (
              <>
                ...
                <Button
                  className="rounded-full bg-[#D4E3FE] px-6 py-6 text-base font-medium text-gray-800 hover:bg-[#c4d3ee] transition-all hover:scale-105 flex items-center justify-center gap-2"
                  onClick={handleLogout}>
                  <LogOut className="h-5 w-5" />
                  Logout
                </Button>
